...
/**
 * The atomic base types: int, double, char, bool, void.
 * These are SINGLETONS, so reference identity ({@code ==}) is exactly
 * structural equality — which is what {@link #same(Type)} uses.
 */
public final class BaseType extends Type {

    public final String name;
    private BaseType(String name) { this.name = name; }
    ...
    @Override public boolean same(Type other) { return this == other; }

    @Override public boolean isNumeric() { return this == INT || this == DOUBLE; }
